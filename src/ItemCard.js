...
const ItemCard = ({fooditem}) => {
  ...
  return (
    ...
    <div>
      <hr className=" w-3/4  bg-gray-200 h-0.5 m-auto  mb-5 "></hr>

      <div className='flex p-1 gap-2 bg-white items-center w-3/4 
    mx-auto m-4 justify-between   '>

        <div className='w-3/4'>
          <h4 className='font-medium text-lg'>{name}</h4>
          <p className='font-medium text-sm' >{(price || defaultPrice) / 100
          } Rs</p>
